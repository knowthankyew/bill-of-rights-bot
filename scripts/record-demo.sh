#!/usr/bin/env bash
# ==============================================================================
# BillOfRightsBot - Automated Playwright Video Demo Recorder
...
echo "=========================================================="
echo "  ⚖️  BillOfRightsBot - Playwright Demo Video Recorder"
echo "=========================================================="
...
if ! curl -s "${URL}" >/dev/null 2>&1; then
  echo "🚀 Starting temporary Vite instance on ${URL}..."
